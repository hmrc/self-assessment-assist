...
object CommonTestData {
  ...
  val simpleTaxYear           = TaxYear.fromMtd("2021-22")
  ...
  val rdsAssessmentAckJson: JsValue = StubResource.loadAckResponseTemplate(simpleReportId.toString, nino = simpleNino, responseCode = 202)
